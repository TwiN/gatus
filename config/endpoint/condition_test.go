...
func TestCondition_evaluate(t *testing.T) {
	scenarios := []struct {
	...
	}{
		{
			...
			Result:          &result.Result{IP: "127.0.0.1"},
		...
		},
		{
			...
			Result:          &result.Result{HTTPStatus: 200},
			ExpectedSuccess: true,
		...
		},
		{
			Name:            "status-failure",
			Condition:       Condition("[STATUS] == 200"),
			Result:          &result.Result{HTTPStatus: 500},
		...
		},
		{
			...
			Result:          &result.Result{HTTPStatus: 201},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Condition:       Condition("[STATUS] < 300"),
			Result:          &result.Result{HTTPStatus: 404},
			ExpectedSuccess: false,
		...
		},
		{
			...
			Result:          &result.Result{Duration: 50 * time.Millisecond},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Condition:       Condition("[RESPONSE_TIME] > 500"),
			Result:          &result.Result{Duration: 750 * time.Millisecond},
			ExpectedSuccess: true,
			ExpectedOutput:  "[RESPONSE_TIME] > 500",
		},
		{
			...
			Condition:       Condition("[RESPONSE_TIME] > 1s"),
			Result:          &result.Result{Duration: 2 * time.Second},
			ExpectedSuccess: true,
			ExpectedOutput:  "[RESPONSE_TIME] > 1s",
		},
		{
			...
			Condition:       Condition("[RESPONSE_TIME] >= 500"),
			Result:          &result.Result{Duration: 500 * time.Millisecond},
			ExpectedSuccess: true,
			ExpectedOutput:  "[RESPONSE_TIME] >= 500",
		},
		{
			...
			Condition:       Condition("[RESPONSE_TIME] >= 500"),
			Result:          &result.Result{Duration: 499 * time.Millisecond},
			ExpectedSuccess: false,
		...
		},
		{
			...
			Condition:       Condition("[RESPONSE_TIME] <= 500"),
			Result:          &result.Result{Duration: 25 * time.Millisecond},
			ExpectedSuccess: true,
			ExpectedOutput:  "[RESPONSE_TIME] <= 500",
		},
		{
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("test")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("123")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Condition:       Condition("[BODY] > 123"),
			Result:          &result.Result{Body: []byte("100")},
			ExpectedSuccess: false,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("{\"status\":\"UP\"}")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("{\"data\": {\"id\": 1, \"name\": \"john\"}}")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Condition:       Condition("[BODY].data.name == john"),
			Result:          &result.Result{Body: []byte("{\"data\": {\"id\": 1}}")},
			ExpectedSuccess: false,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("{\"user\": {\"firstName\": \"john\", \"lastName\": \"doe\"}}")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("[{\"id\": 1}, {\"id\": 2}]")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte(`{"data": null}"`)},
			ExpectedSuccess: false,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte(`{"items": [null, null]}"`)},
			ExpectedSuccess: false,
		...
		},
		{
			...
			Condition:       Condition("[BODY].data == OK"),
			Result:          &result.Result{Body: []byte(`null`)},
			ExpectedSuccess: false,
			ExpectedOutput:  "[BODY].data (INVALID) == OK",
		},
		{
			...
			Result:          &result.Result{Body: []byte("{\"statusCode\": 500, \"message\": \"Internal Server Error\"}")},
			ExpectedSuccess: false,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("{\"data\": [{\"id\": 1}, {\"id\": 2}, {\"id\": 3}]}")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("{\"data\": \"0x1\"}")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("{\"data\": \"0x2\"}")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("{\"data\": \"0xF\"}")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("{\"data\": \"0xC0ff33\"}")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Condition:       Condition("[BODY].data >= 1"),
			Result:          &result.Result{Body: []byte("{\"data\": \"0x01\"}")},
			ExpectedSuccess: true,
			ExpectedOutput:  "[BODY].data >= 1",
		},
		{
		...
		},
		{
			...
			Condition:       Condition("[BODY].data > 0"),
			Result:          &result.Result{Body: []byte("{\"data\": \"0o1\"}")},
			ExpectedSuccess: true,
			ExpectedOutput:  "[BODY].data > 0",
		},
		{
			...
			Condition:       Condition("[BODY].data == 2"),
			Result:          &result.Result{Body: []byte("{\"data\": \"0o2\"}")},
			ExpectedSuccess: true,
			ExpectedOutput:  "[BODY].data == 2",
		},
		{
		...
		},
		{
			...
			Condition:       Condition("[BODY].data > 0"),
			Result:          &result.Result{Body: []byte("{\"data\": \"0b1\"}")},
			ExpectedSuccess: true,
			ExpectedOutput:  "[BODY].data > 0",
		},
		{
			...
			Condition:       Condition("[BODY].data == 2"),
			Result:          &result.Result{Body: []byte("{\"data\": \"0b0010\"}")},
			ExpectedSuccess: true,
			ExpectedOutput:  "[BODY].data == 2",
		},
		{
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte(`{"balance": "123.40000000000005"}`)},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Condition:       Condition("[BODY].data.id < 5"),
			Result:          &result.Result{Body: []byte("{\"data\": {\"id\": 2}}")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Condition:       Condition("[BODY].data.id < 5"),
			Result:          &result.Result{Body: []byte("{\"data\": {\"id\": 10}}")},
			ExpectedSuccess: false,
		...
		},
		{
			...
			Result:          &result.Result{Connected: true},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Condition:       Condition("[CONNECTED] == true"),
			Result:          &result.Result{Connected: false},
			ExpectedSuccess: false,
		...
		},
		{
			...
			Result:          &result.Result{CertificateExpiration: time.Hour * 24 * 60},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Condition:       Condition("[CERTIFICATE_EXPIRATION] > " + strconv.FormatInt((time.Hour*24*28).Milliseconds(), 10)),
			Result:          &result.Result{CertificateExpiration: time.Hour * 24 * 14},
			ExpectedSuccess: false,
		...
		},
		{
			...
			Result:          &result.Result{CertificateExpiration: 24 * time.Hour},
			ExpectedSuccess: true,
		...
		// len
		{
			...
			Result:          &result.Result{Body: []byte("{\"data\": {\"name\": \"john\"}}")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("[{\"id\": 1}, {\"id\": 2}, {\"id\": 3}]")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("{\"name\": \"john.doe\"}")},
			ExpectedSuccess: false,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("john.doe")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte(`{"age":18}`)},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte(`{"adult":true}`)},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte(`[{"age":18,"adult":true}]`)},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte(`<!DOCTYPE html><html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /></head><body><div id="user">john.doe</div></body></html>`)},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Condition:       Condition("[BODY] == pat(*<div id=\"user\">john.doe</div>*)"),
			Result:          &result.Result{Body: []byte(`<!DOCTYPE html><html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /></head><body><div id="user">jane.doe</div></body></html>`)},
			ExpectedSuccess: false,
		...
		},
		{
			...
			Result:          &result.Result{Body: []byte("{\"data\": [\"hello\", \"world\", \"Whatever\"]}")},
			ExpectedSuccess: true,
		...
		},
		{
			...
			Result:          &result.Result{IP: "10.0.0.0"},
			ExpectedSuccess: true,
		...
		},
		{
			Name:            "pat-ip-failure",
			Condition:       Condition("[IP] == pat(10.*)"),
			Result:          &result.Result{IP: "255.255.255.255"},
			ExpectedSuccess: false,
		...
		},
		{
			Name:            "any-body-2",
			Condition:       Condition("[BODY].name == any(john.doe, jane.doe)"),
			Result:          &result.Result{Body: []byte("{\"name\": \"jane.doe\"}")},
			ExpectedSuccess: true,
			ExpectedOutput:  "[BODY].name == any(john.doe, jane.doe)",
		},
		{
			...
			Condition:       Condition("[BODY].name == any(john.doe, jane.doe)"),
			Result:          &result.Result{Body: []byte("{\"name\": \"bob\"}")},
			ExpectedSuccess: false,
		...
		},
		{
			Name:            "any-status-2",
			Condition:       Condition("[STATUS] == any(200, 429)"),
			Result:          &result.Result{HTTPStatus: 429},
			ExpectedSuccess: true,
			ExpectedOutput:  "[STATUS] == any(200, 429)",
		},
		{
		...
		// has
		{
			...
			Result:          &result.Result{Body: []byte("{}")},
			ExpectedSuccess: true,
		...
		},
		{
			Name:            "has-failure",
			Condition:       Condition("has([BODY].errors) == false"),
			Result:          &result.Result{Body: []byte("{\"errors\": [\"1\"]}")},
			ExpectedSuccess: false,
