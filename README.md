...
| `endpoints[].ui.badge.reponse-timer.thresholds` | Threshold array for response time badge color grading (values have to raise in an ascending order)                                          | `[50, 200, 300, 500, 750]` |
