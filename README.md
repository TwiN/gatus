...
| `endpoints[].ui.links`                          | List of external links to display for the endpoint (e.g. a link to the service's own dashboard or repository).                              | `[]`                       |
| `endpoints[].ui.links[].name`                   | Text to display for the link.                                                                                                                | Required `""`              |
| `endpoints[].ui.links[].value`                  | URL the link points to.                                                                                                                      | Required `""`              |
