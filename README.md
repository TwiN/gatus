...
| `external-endpoints[].heartbeat.interval` | Time between checks for new status pushes to the endpoint. If no status is pushed within this period, alerts will be triggered. Must be at least 10s. | `0` (disabled) |
