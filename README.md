...
| `endpoints[].ui.badge.reponse-time.thresholds`  | List of response time thresholds. Each time a threshold is reached, the badge has a different color.                                        | `[50, 200, 300, 500, 750]` |
