...
const filterBy = ref(localStorage.getItem('gatus:filter-by') || (typeof window !== 'undefined' && globalThis.config?.defaultFilterBy) || 'none')
const sortBy = ref(localStorage.getItem('gatus:sort-by') || (typeof window !== 'undefined' && globalThis.config?.defaultSortBy) || 'name')
