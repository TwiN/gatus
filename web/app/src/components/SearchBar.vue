    ...
    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
      <div class="flex items-center gap-2 flex-1 sm:flex-initial">
        ...
        <Select 
          ...
          :placeholder="t('search.filterNone')"
...
const filterOptions = computed(() => ([
  { label: t('search.filterNone'), value: 'none' },
  { label: t('search.filterFailing'), value: 'failing' },
  { label: t('search.filterUnstable'), value: 'unstable' }
]))

const sortOptions = computed(() => ([
  { label: t('search.sortName'), value: 'name' },
  { label: t('search.sortGroup'), value: 'group' },
  { label: t('search.sortHealth'), value: 'health' }
]))
