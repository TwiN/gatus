        ...
        <div>
          <div class="flex items-center justify-between mb-1">
            ...
            <p
              ...
              :title="showAverageResponseTime ? t('endpointCard.averageResponseTimeTitle') : t('endpointCard.minMaxResponseTimeTitle')"
            >
...
const formattedResponseTime = computed(() => {
  ...
  if (count === 0) return t('endpointCard.noData')
